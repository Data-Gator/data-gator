...
{
public:
    virtual double getUM(const double voltage) = 0;                                                        // Returns the diameter of the tree in micrometers
    virtual std::string getSensorType() = 0;                                                           // Returns the name of the sensor
    virtual std::string toJSON(const double rawADC) = 0;                                               // Returns a JSON string of the sensor's data
protected:
